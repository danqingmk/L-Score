...
for item in (os.listdir(rootdir +'/user_input/results_docking/{}/'.format(sys.argv[1]))):
...
for ii in range(len(ligand_list)):
    ...
    fp_lsalign = open(rootdir + '/user_input/results_docking/{}/'.format(sys.argv[1])+ligand_list[ii]+lsalign_name)
...
fpout = open(rootdir + '/user_input/results_docking/Lscore.result' ,'w')
