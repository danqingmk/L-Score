...
# for item in (os.listdir(rootdir + '/user_input/results_docking/active_mol2/')):
for item in (os.listdir('/data/Mukuo/A1AR/ucsf_redock/active_decoy_mol2_for_plscore/')):
...
for ii in range(len(ligand_list)):
    ...
    # fp_lsalign = open(rootdir + '/user_input/results_docking/active_mol2/'+ligand_list[ii]+lsalign_name)
    fp_lsalign = open('/data/Mukuo/A1AR/ucsf_redock/active_decoy_mol2_for_plscore/' + ligand_list[ii] + lsalign_name)
