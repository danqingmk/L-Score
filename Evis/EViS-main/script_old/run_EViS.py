...
BioLip = '/data/wanglin/EViS-main/BioLip/'  ### update
#
#
# #### step 1: ppsalign
...
# command = 'cp ' + rootdir +'/user_input/results_docking/pocket/pocket_topN* ' + rootdir +'/user_input/results_docking/active_mol2/'
command = 'cp ' + rootdir +'/user_input/results_docking/pocket/pocket_topN* ' + '/data/Mukuo/A1AR/ucsf_redock/active_decoy_mol2_for_plscore/'
stdout,stderr = subprocess.Popen(';'.join([command]),shell=True).communicate()
...
# # command1 = 'cd ' + rootdir +'/user_input/results_docking/active_mol2/'
# command1 = 'cd ' + '/data/Mukuo/A1AR/ucsf_redock/active_decoy_mol2_for_plscore/'
# total_mol2 = list()
# lsalign_index = 0
# # for mol2_item in (os.listdir(rootdir +'/user_input/results_docking/active_mol2/')):
# for mol2_item in (os.listdir('/data/Mukuo/A1AR/ucsf_redock/active_decoy_mol2_for_plscore/')):
#
