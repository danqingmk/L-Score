...
for item in (os.listdir(rootdir + '/user_input/results_docking/ligand_mol2/')):
...
for ii in range(len(ligand_list)):
    ...
    fp_lsalign = open(rootdir + '/user_input/results_docking/ligand_mol2/'+ligand_list[ii]+lsalign_name)
...
fpout = open(rootdir + '/user_input/results_docking/LS_score.result' ,'w')
